package com.ianm1647.orchardistsdream.integration.jei.category;
...
import com.ianm1647.orchardistsdream.integration.jei.JEIRecipeTypes;
...
public class JuicingRecipeCategory implements IRecipeCategory<JuicerRecipe> {
   ...
   private final Component title = Component.translatable("orchardistsdream.jei.juicing");
   private final IDrawable background;
   private final IDrawable icon;

   public JuicingRecipeCategory(IGuiHelper helper) {
      ResourceLocation backgroundImage = new ResourceLocation(OrchardistsDream.MODID, "textures/gui/jei/juicer.png");
      this.background = helper.createDrawable(backgroundImage, 29, 6, 117, 67);
      this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack((ItemLike) ODItems.JUICER.get()));
